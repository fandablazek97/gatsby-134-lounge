  ...
  return (
    <section id="o-nas" className="relative py-24 md:py-36 lg:py-48">
      <div className="ui-wrapper">
        ...
        >
          Moderní shisha bar v centru Plzně s širokou nabídkou kvalitních
          tabáků, alkoholických a nealkoholických koktejlů a nápojů. Najdete nás
          nedaleko sadů Pětatřicátníků.
        </SlideUp>
