  ...
  return (
    <footer className="w-screen">
      ...
      >
        ...
        <AnchorLink
          to="/de/#top"
          className="ui-link data-link-2 absolute top-10 left-1/2 flex -translate-x-1/2 -translate-y-1/2 lg:top-1/2 lg:hidden xl:flex"
        >
        ...
        <div className="mt-6 flex flex-col items-center justify-center lg:mt-0 lg:flex-row lg:justify-end lg:space-x-5 xl:space-x-10">
          <FooterInfoModal className="ui-link data-link-2 block text-center text-xs font-medium uppercase text-gray-600 lg:text-white">
